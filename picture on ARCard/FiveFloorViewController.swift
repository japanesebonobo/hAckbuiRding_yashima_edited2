...
class FiveFloorViewController: UIViewController,  UIPickerViewDelegate, UIPickerViewDataSource {
    @IBOutlet weak var fivefloorImageView: UIImageView!
    ...
    let fivefloorImage = UIImage(named: "art.scnassets/階層画像/5f.png")!
    ...
    override func viewDidLoad() {
        ...
        fivefloorImageView.image = fivefloorImage
        ...
        let cancelButton = UIBarButtonItem(title: "Cancel", style: UIBarButtonItem.Style.plain, target: self, action: #selector(FiveFloorViewController.cancelPressed))
