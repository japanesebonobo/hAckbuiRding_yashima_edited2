...
class SecondFloorViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    @IBOutlet weak var twofloorImageView: UIImageView!
    ...
    let twofloorImage = UIImage(named: "art.scnassets/階層画像/2f.png")!
    ...
    override func viewDidLoad() {
        ...
        twofloorImageView.image = twofloorImage
        ...
        let cancelButton = UIBarButtonItem(title: "Cancel", style: UIBarButtonItem.Style.plain, target: self, action: #selector(SecondFloorViewController.cancelPressed))
