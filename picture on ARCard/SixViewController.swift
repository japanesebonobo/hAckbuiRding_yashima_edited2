...
class SixViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    @IBOutlet weak var sixfloorImageView: UIImageView!
    ...
    let sixfloorImage = UIImage(named: "art.scnassets/階層画像/6f.png")!
    
    let iconDescription = UIImage(named: "art.scnassets/アイコン説明.png")!
    
    let starbucksImage = UIImage(named: "art.scnassets/6F/Starbucks_Coffee.png")!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        sixfloorImageView.image = sixfloorImage
        
        iconDescription_layer3.image = iconDescription
        
        starbucks.setImage(starbucksImage, for: .normal)
        ...
        let cancelButton = UIBarButtonItem(title: "Cancel", style: UIBarButtonItem.Style.plain, target: self, action: #selector(SixViewController.cancelPressed))
