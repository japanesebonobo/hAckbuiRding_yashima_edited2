...
class ThreeFloorViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    @IBOutlet weak var threefloorImageView: UIImageView!
    ...
    let threefloorImage = UIImage(named: "art.scnassets/階層画像/3f.png")!

    let iconDescription = UIImage(named: "art.scnassets/アイコン説明.png")!
    let afternoonImage = UIImage(named: "art.scnassets/3F/Afternoon_Tea_Tearoom.png")!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        threefloorImageView.image = threefloorImage
        
        iconDescription_layer3.image = iconDescription
        
        afternoon.setImage(afternoonImage,for: .normal)
        ...
        let cancelButton = UIBarButtonItem(title: "Cancel", style: UIBarButtonItem.Style.plain, target: self, action: #selector(ThreeFloorViewController.cancelPressed))
